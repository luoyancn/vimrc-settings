# Generated by Powerlevel10k configuration wizard on 2021-06-12 at 14:20 CST.
...
() {
  ...
  #################################[ os_icon: os identifier ]##################################
  # OS identifier color.
  typeset -g POWERLEVEL9K_OS_ICON_FOREGROUND=028
  ...
  typeset -g POWERLEVEL9K_DIR_BACKGROUND=025
  ...
  typeset -g POWERLEVEL9K_VCS_CLEAN_BACKGROUND=148 #190
  typeset -g POWERLEVEL9K_VCS_MODIFIED_BACKGROUND=250
  typeset -g POWERLEVEL9K_VCS_UNTRACKED_BACKGROUND=148 #190
  ...
  function my_git_formatter() {
    ...
    local      clean='%23F' # black foreground
  ...
  typeset -g POWERLEVEL9K_CONTEXT_ROOT_FOREGROUND=024
  typeset -g POWERLEVEL9K_CONTEXT_ROOT_BACKGROUND=250
  # Context color in SSH without privileges.
  typeset -g POWERLEVEL9K_CONTEXT_{REMOTE,REMOTE_SUDO}_FOREGROUND=024
  typeset -g POWERLEVEL9K_CONTEXT_{REMOTE,REMOTE_SUDO}_BACKGROUND=250
  # Default context color (no privileges, no SSH).
  typeset -g POWERLEVEL9K_CONTEXT_FOREGROUND=024
